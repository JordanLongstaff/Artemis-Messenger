...
public class CommsOutgoingPacket extends BaseArtemisPacket {
     ...
     * be thrown.
     */
    public CommsOutgoingPacket(ArtemisObject target, CommsMessage msg, ArtemisContext ctx) {
     ...
     */
    public CommsOutgoingPacket(ArtemisObject recipient, CommsMessage msg, int arg, ArtemisContext ctx) {
        if (recipient == null)
        	throw new IllegalArgumentException("Outgoing Comms packet with no recipient");
        if (msg == null)
        	throw new IllegalArgumentException("Outgoing Comms packet with no message");
        ...
        if (msg.hasArgument() && arg == NO_ARG)
        	throw new IllegalArgumentException("Message " + msg + " requires an argument");

        if (!msg.hasArgument() && arg != NO_ARG)
        	throw new IllegalArgumentException("Message " + msg + " does not accept an argument");
