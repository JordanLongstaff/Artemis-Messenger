...
public final class JamCrc {
	...
	/**
	 * Computes a checksum for the UTF-8 representation of the given CharSequence.
	 * Note that although CharSequences are transmitted in UTF-16LE in the Artemis
	 * protocol, checksums are still computed in UTF-8.
	 */
